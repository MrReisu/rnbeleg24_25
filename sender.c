...
#define TIMEOUT 900000 // 3 * 300 ms
...
int main(int argc, char *argv[]) {
    ...
    int acked[MAX_WINDOW_SIZE] = {0}; // ACK-Status für jedes Fensterpaket
    char window[MAX_WINDOW_SIZE][MAX_LINE]; // Puffer für das Sendefenster

    struct timeval interval = {0, INTERVAL};
